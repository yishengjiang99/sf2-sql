...
create table inst(
	id int,
	name varchar(20),
	ibag_id smallint unsigned,
	index(id)
);

create table ibag(
	id int,
	igen_id smallint unsigned,
	imod_id smallint unsigned
);
...
startLoop int unsigned,
endLoop int unsigned,
sampleRate int unsigned,
originalPitch smallint unsigned,
pitchCorrection smallint,
